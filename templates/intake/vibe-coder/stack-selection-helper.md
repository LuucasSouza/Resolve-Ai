---
title: "Stack Selection Helper"
template_id: "vibe-coder.stack-selection"
version: "0.1.0"
status: "draft"
...
next_engine: "Architecture Engine"
...
Need login? save data? payments? admin panel? public pages? real-time? file uploads? many users soon?

## 7. Output format

Recommended type: static site, simple web app, SaaS MVP, internal tool, automation workflow, AI assistant, marketplace or dashboard.
Default stack:
Reasons:
Risks:
Deferred complexity:
