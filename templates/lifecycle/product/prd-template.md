...
Capture: product vision, target users, problem, goals, non-goals, features, stories, acceptance criteria, MVP, dependencies, risks, metrics, release strategy.
